...
$router->group(['prefix' => 'api/'],function () use ($router) {
    ...
    $router->get('/attendanceview', 'SheetController@index');
    $router->post('/getSearchAttendance', 'SheetController@getSearchResults');
    $router->get('/checklate/{employee_id}','SheetController@showLate');
