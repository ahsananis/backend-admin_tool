...
class SheetController extends Controller
{
  ...
  {
      $data = Attendance::all();
      return response()->json(array('status' => '200','attendance' => ($data)));
  }
...
//Show all late of employee in excel file.

public function showLate($employee_id){
  $attcheck = Attendance::find($employee_id)->get;
  dd($attcheck);
  // return response()->json(($attcheck));
}
